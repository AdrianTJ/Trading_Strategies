...
**Phase:** 2 — Core Simulation Engine ✓ complete → Phase 3 — Analytics & Performance Visuals
**Status:** planning
...
- **Key libraries:** pandas, fredapi, TimescaleDB, Lightweight Charts
- **Dev server:** `uvicorn main:app --reload` (FastAPI), `npm run dev` (Vite)
...
1. Read `/Users/saintcloud/Documents/trading_strategies/.gemini/learnship/skills/agentic-learning/SKILL.md`
...
1. Read `/Users/saintcloud/Documents/trading_strategies/.gemini/learnship/skills/impeccable/SKILL.md`
